...
- **FAIL:** Stop. Implementation switches to filesystem fallback (Spec §8, "Refine OK but session path not found in skill ledger" row). Write the fallback code path in Task 3 instead of the ledger-read helper.
